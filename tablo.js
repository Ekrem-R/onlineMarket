                ...
                return (`${tableData.map(item => {
                    return (
                        `<tr id="item">
                            ...
                            <td class="addSepet"> <i class="fas fa-shopping-cart"></i></td>
...
const createBasketTable = tableData => {
    return (`${tableData.map(item => {
        return (
            `<tr id="removeItem">
                <td>${item.productName}</td>
                <td>${item.price}</td>
                <td><img src="${item.productImage}"</img></td>
                <td class="removeSepet"> <i class="fas fa-trash-alt"></i></td>
...
const newinit = () => {   
    let tableFilter = createBasketTable(productList);
    appendTable(tableFilter, '#basketTable tbody');   
              }
              newinit();
...
let removeElementFromTable= document.querySelector(".removeSepet");
